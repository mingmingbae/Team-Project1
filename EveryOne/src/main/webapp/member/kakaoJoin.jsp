...
<%@ page language="java" contentType="text/html; charset=UTF-8"
 ...
 <%
	...
	KakaoUserVo kakaoUserVo = (KakaoUserVo)request.getAttribute("kakaoUserVo");
%>
...
<form id="registrationForm" action="<%=contextPath%>/Member/kakaoJoin2.do?center=main.jsp" class="form">	
...
<%-- 회원가입 유효성 검사 체크 --%>
<script src="<%=contextPath %>/js/join5.js"></script>
