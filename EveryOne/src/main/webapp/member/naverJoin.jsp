...
<%@ page contentType="text/html;charset=UTF-8" language="java" %>
 ...
 <%
	...
	NaverUserVo naverUserVo = (NaverUserVo)request.getAttribute("NaverUserVo");
%>
...
<form id="registrationForm" action="<%=contextPath%>/Member/NaverJoin.do?center=main.jsp" class="form">	
			...
			<div class="form-group">
				<div class="row">
					...
					<div class="col-6">
						...
						<div id="birthInput" class="error"></div>
					</div>							
				</div>
			</div>
