...
<%
	...
	int totalSales = (Integer)request.getAttribute("totalSales");
	int regiProCount = (Integer)request.getAttribute("regiProCount");
%>
<!DOCTYPE html>
<html lang="en">
    <head>
                ...
                <nav class="sb-sidenav accordion sb-sidenav-dark" id="sidenavAccordion">
                    <div class="sb-sidenav-menu">
                        <div class="nav">
                            ...
                            <a class="nav-link" href="<%=contextPath%>/Mypage/proUpInfo?center=mypage/proUpInfo.jsp">
                                <div class="sb-nav-link-icon"><i class="fas fa-tachometer-alt"></i></div>
                                상품등록
                            </a>
                            <a class="nav-link" href="<%=contextPath%>/Mypage/updateView?center=mypage/updateView.jsp&m_id=<%=m_id%>">
                                <div class="sb-nav-link-icon"><i class="fas fa-tachometer-alt"></i></div>
                                상품수정
                            </a>
                        ...
                        <div class="row">
                            <div class="col-xl-3 col-md-6">
                                <div class="card bg-primary text-white mb-4">
                                    <div class="card-body">등록 상품 수량</div>
                                    <div class="card-footer d-flex align-items-center justify-content-between">
                                        <a class="small text-white stretched-link" href="#"><%=regiProCount %></a>
                            ...
                            <div class="col-xl-3 col-md-6">
                                <div class="card bg-success text-white mb-4">
                                    <div class="card-body">상품 총 매출액</div>
                                    <div class="card-footer d-flex align-items-center justify-content-between">
                                        <a class="small text-white stretched-link" href="#"><%=totalSales %></a>
                                        <div class="small text-white"><i class="fas fa-angle-right"></i></div>
                                    </div>
                                </div>
                            </div>
                            <div class="col-xl-3 col-md-6">
                                <div class="card bg-warning text-white mb-4">
                                    <div class="card-body">서비스 준비 중</div>
                                    <div class="card-footer d-flex align-items-center justify-content-between">
                                ...
                                <table id="datatablesSimple">
									...
									%>			
										<tr>
							               <td><%=vo.getP_idx() %> </td>
							               <td><%=vo.getP_name() %> </td>
							               <td><img alt="" src="<%=contextPath %>/productimage/<%=vo.getP_idx() %>/<%=vo.getImgVo().getI_name() %>" style="max-width: 50px; max-height: 50px;"></td>
							               <td><%=vo.getP_color() %></td>
							               <td><%=vo.getP_size() %></td>
							               <td><%=vo.getP_category() %></td>
							               <td><%=vo.getP_price() %></td>
							               <td><%=vo.getP_codytemp() %></td> 
							       		</tr>
									<%		}%>
									<%	}%>
                                    </tbody>
