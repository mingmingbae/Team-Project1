...
<form action="<%=contextPath%>/Mypage/memupdate.do?center=mypage/mypage1.jsp" class="form" method="post">	
			...
			<div class="row">
				<div class="col">
					<a href="#" onclick="check(); return false;" 
					   type="button"
						class="btn btn-primary btn-block">회원정보 수정하기</a>
				</div>
			</div>
			<br /> <br /> <br />
...
<%-- 회원수정 유효성 검사 체크  --%>
<script src="<%=contextPath %>/js/join2.js"></script>
