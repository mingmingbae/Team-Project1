...
<body>
	...
	<form action="<%=contextPath%>/Pants/searchList.do" name="search"
	...
	<div class="price_list">
		<p>
			<a href="<%=contextPath%>/Pants/priceAsc.do">낮은가격</a>
			<a href="<%=contextPath%>/Pants/pricDesc.do">높은가격</a>
		</p>
	</div>
			...
			<div class="item_list">
				...
				<div class="card">
					...
					<div class="text" id="price">
						...
						<form action="${contextPath}/Pants/productDetail.do">
	...
	%>
	<a
		href="<%=contextPath%>/Pants/list.do?center=pants.jsp&nowBlock=<%=nowBlock - 1%>&nowPage=<%=((nowBlock - 1) * pagePerBlock)%>">
		◀ 이전 <%=pagePerBlock%> 개
	</a>
	<%
		} //if
	...
	&nbsp;&nbsp;
	<a
		href="<%=contextPath%>/Pants/list.do?center=pants.jsp&nowBlock=<%=nowBlock%>&nowPage=<%=(nowBlock * pagePerBlock) + i%>">
