...
<body>
	...
	<form action="<%=contextPath%>/Shirts/searchList.do" name="search"
	...
	<div class="price_list">
		<p>
			<a href="<%=contextPath%>/Shirts/priceAsc.do">낮은가격</a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
			<a href="<%=contextPath%>/Shirts/pricDesc.do">높은가격</a>
		</p>
	</div>
			...
			<div class="item_list">
				...
				<div class="card">
					...
					<div class="text" id="price">
						...
						<form action="<%=contextPath%>/Shirts/productDetail.do">
							...
							<input type="hidden" name="p_content" value="<%=((HashMap) list.get(i)).get("p_content") %>">	
	...
	%>
	<a
		href="<%=contextPath%>/Shirts/list.do?center=shirts.jsp&nowBlock=<%=nowBlock - 1%>&nowPage=<%=((nowBlock - 1) * pagePerBlock)%>">
		◀ 이전 <%=pagePerBlock%> 개
	</a>
	<%
		} //if
	...
	&nbsp;&nbsp;
	<a
		href="<%=contextPath%>/Shirts/list.do?center=shirts.jsp&nowBlock=<%=nowBlock%>&nowPage=<%=(nowBlock * pagePerBlock) + i%>">
