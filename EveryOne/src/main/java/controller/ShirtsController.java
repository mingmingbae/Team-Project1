...
@WebServlet("/Shirts/*")
public class ShirtsController extends HttpServlet {
	...
	public void doHandle(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		switch (action) {
		case "/list.do":	// 중간 네비게이션 상의 페이지 요청
			
			list = shirtsService.serviceshirtsList(request);
			
			center = "shirts/shirts.jsp";
		...
		case "/priceAsc.do": //낮은 가격순 정렬
			...
			list = shirtsService.servicePriceAsc(request);
		...
		case "/pricDesc.do": //높은 가격순 정렬	
			...
			list = shirtsService.servicePriceDesc(request);
		...
		case "/searchList.do": //상품명 검색
			...
			list = shirtsService.serviceSerachList(request);
			center = "shirts/shirts.jsp";
		...
		case "/productDetail.do" : //상세페이지에 보여줄 상품 정보
			...
			center = "shirts/productDetail.jsp";
			...
			request.setAttribute("p_content", request.getParameter("p_content"));
